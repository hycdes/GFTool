...
function changePreview () { // 改变预览显示，也会改变装备对应全局变量set_equip
  ...
  if (ID === 0 | ID === 1) {
    ...
    */
    ...
    if (e_dmg > 0 && e_dmg != 2.01) document.getElementById('info_dmg').innerHTML = '伤害 <span style="color:green">' + property_display.dmg + '+' + e_dmg + '</span>'
    else if (e_dmg < 0) document.getElementById('info_dmg').innerHTML = '伤害 <span style="color:orangered">' + property_display.dmg + e_dmg + '</span>'
    else if (e_dmg === 2.01) document.getElementById('info_dmg').innerHTML = '伤害 <span style="color:blue">' + property_display.dmg + 'x3' + '</span>'
    else document.getElementById('info_dmg').innerHTML = '伤害 <span style="color:green">' + property_display.dmg + '</span>'
    ...
    if (e_acu > 0) document.getElementById('info_acu').innerHTML = '命中 <span style="color:green">' + property_display.acu + '+' + e_acu + '</span>'
    else if (e_acu < 0) document.getElementById('info_acu').innerHTML = '命中 <span style="color:orangered">' + property_display.acu + e_acu + '</span>'
    else document.getElementById('info_acu').innerHTML = '命中 <span style="color:green">' + property_display.acu + '</span>'
    if (e_eva > 0) document.getElementById('info_eva').innerHTML = '闪避 <span style="color:green">' + property_display.eva + '+' + e_eva + '</span>'
    else if (e_eva < 0) document.getElementById('info_eva').innerHTML = '闪避 <span style="color:orangered">' + property_display.eva + e_eva + '</span>'
    else document.getElementById('info_eva').innerHTML = '闪避 <span style="color:green">' + property_display.eva + '</span>'
