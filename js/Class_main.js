...
var lib_name = {
  ...
  t37: 'M14', t256: '隼',
  // —————————————— MG ——————————————
  t2021: '阿尔玛·阿玛斯', t2026: '库拉耶丝', t2033: '花园百合铃',
  t1125: 'MG4 MOD',
...
var lib_tdoll = [
  ...
  create_entry([2, 4, 1071], ['dps', 'supportdps', 'longfill'], ['front'], ['forcus_acu', 'forcus_crit', 'command_acu'], []),
  ...
  create_entry([3, 5, 1136], ['dps', 'tank_eva', 'af_dmg'], ['random'], ['forcus_dmg', 'forcus_eva', 'handgrenade'], []),
  ...
  create_entry([4, 5, 329], ['dps'], ['back', 'suggest_7'], ['forcus_dmg', 'ap', 'dmgstatic'], []),
  ...
  create_entry([5, 1, 2033], ['dps', 'af_arm'], ['random'], ['command_dmg', 'command_addcs', 'weak_rof', 'weak_movespeed', 'ap', 'grenade', 'dizz'], []),
  create_entry([5, 6, 1125], ['dps', 'supportdfs', 'longdps', 'af_arm'], ['random'], ['forcus_dmg', 'forcus_addcs', 'weak_dmg', 'ap', 'multitarget', 'passive'], []),
